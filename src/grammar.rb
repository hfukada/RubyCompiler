...
class Grammar 
    ...
    "if_stmt"          => "IF ( cond condend decl stmt_list else_part",
    "else_part"        => "ELSIF ( cond condend decl stmt_list else_part | ENDIF",
